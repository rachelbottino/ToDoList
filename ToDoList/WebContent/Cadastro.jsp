...
<body>
	<div class="login" id="cadastrar">
	  <header class="login-header"><span class="text">Cadastro</span><span class="loader"></span></header>
	  <form class="login-form align-center" method='get' enctype="multipart/form-data">
	    ...
	    <input type="submit" name="cadastrar" value="Cadastre-se" class="btn btn-primary">
	    <br>
	  </form>
	</div>
